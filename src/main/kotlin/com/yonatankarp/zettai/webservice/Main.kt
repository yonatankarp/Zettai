...
private fun ToDoListHub.withExampleToDoList(): ToDoListHub = also { handle(CreateToDoList(User("uberto"), ListName("book"))) }

private fun ToDoListHub.withExampleItems(): ToDoListHub = also { exampleItems.forEach { handle(it) } }

private val exampleItems =
    sequence {
